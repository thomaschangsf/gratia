...
## ------------------------------
if [ -f $OPUS_DIR/10_environment/.bash_aliases.sh ]; then
   source $OPUS_DIR/10_environment/.bash_aliases.sh
else
    echo "Cannot find: $OPUS_DIR/10_environment/.bash_aliases.sh"
fi
